    ...
    <ModalCustom nativeModal={false} visible={visible}>
      ...
      >
        <Animated.View style={[styles.container, { backgroundColor, paddingTop: safeArea.top }, contentStyle]}>
          <View testID={testIDDropdown} accessibilityLabel={accessibilityLabelDropdown} style={styles.viewContent}>
            {
              renderIcon ? renderIcon() : <Image source={imageSource} style={styles.image} resizeMode='contain' />
            }
